...
<template>
  <div class="mx-auto flex w-full flex-col px-6 py-6 sm:px-8 lg:gap-8">
    <!-- Hero for proposal -->
      ...
      <UCard>
        ...
        <div class="grid grid-cols-12 gap-6">
          <div class="col-span-12 space-y-4 lg:col-span-8">
            <p class="text-sm">
              Embed a small card showing Dataset Index, FAIR score, citations,
              and mentions for any dataset by DOI. Use an iframe and pass the
              <code
          ...
          <div class="col-span-12 flex flex-col lg:col-span-3">
            <span class="text-muted mb-2 text-xs font-medium">
              Live preview
            </span>
