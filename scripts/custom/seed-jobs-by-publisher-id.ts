...
// Dataset.publisherId values to seed jobs for, e.g. "sul.openneuro"
const PUBLISHER_IDS = ["sul.openneuro", "dartlib.dandi"];
...
const seedJobs = async () => {
  ...
  console.log(
    `\n🌱 Seeding jobs from ${totalCount.toLocaleString()} datasets for publishers: ${PUBLISHER_IDS.join(", ")}`,
  );
